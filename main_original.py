...
def main(args):
    """ Model and Opt """
    model_enc, model_dec = get_models(args.model, args.sc)
    ...
    trainer = Trainer(args.dataset, model_enc, model_dec, channel_m,
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Model agnostic task-oriented communication with feature alignment')
    parser.add_argument('--id', type=int, default=1, help='The index of the independent task-oriented communication')
    parser.add_argument('--model', type=str, default='vgg', help='model: vgg, resnet, or mixed')
    ...
    parser.add_argument('-r', '--root', type=str, default='./local_SVHN', help='The root of trained models')
    ...
    parser.add_argument('-e', '--epoches', type=int, default=340, help='Number of epoches')
    ...
    parser.add_argument('--step', type=int, default=100, help='learn rate')
    ...
    name = args.model + '-' +str(args.id) + '-' + args.channel + '-' + str(args.snr) +'-'+ str(args.sc)
